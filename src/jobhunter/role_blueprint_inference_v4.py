"""Instructor-backed semantic draft generation for Role Capability Blueprint v4."""
...
class RoleBlueprintInferenceProvider:
    """Generate one bounded semantic Blueprint draft without upstream provenance bookkeeping."""
        ...
        *,
        ...
        try:
            ...
            raise InferenceResponseError(
                "Instructor could not produce a structurally valid Role Capability Blueprint v4 "
