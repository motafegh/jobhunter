"""CLI entry helpers for the isolated P1.6 v14 candidate."""
...
def run_candidate_cli() -> int:
    ...
    try:
        ...
        service = build_v14_candidate_analysis_service(settings)
        ...
        print(f"P1.6 v14 candidate failed: {exc}", file=sys.stderr)
        return 1

    print(f"Outcome: {result.outcome}")
    print(f"English P1.6 v14 candidate for {result.source_job_id}")
