...
accepted v23/v5 path while original-language P1.6 remains on the independently validated v9/v4
path.
"""
...
from jobhunter.analysis_runtime_v23 import build_v23_analysis_service
...
class JobAnalysisService:
    ...
    def __init__(
        self,
        *,
        english_service: JobAnalysisServiceV23,
    ...
    def analyze_english_job(self, source_job_id: str) -> AnalysisJobResult:
        """Build or reuse accepted English P1.6 v23/v5."""
    ...
    def run_english(
        ...
        *,
        ...
        """Run bounded accepted English P1.6 v23/v5."""
...
def build_job_analysis_service(settings: Settings) -> JobAnalysisService:
    ...
    return JobAnalysisService(
        english_service=build_v23_analysis_service(settings),
