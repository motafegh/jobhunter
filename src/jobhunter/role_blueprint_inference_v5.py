"""Instructor-backed generation for the bounded Role Capability Blueprint v5 draft."""
...
class RoleBlueprintInferenceProvider:
    """Generate professional interpretation without asking the model to reproduce provenance."""
        ...
        *,
        ...
        try:
            ...
            raise InferenceResponseError(
                "Instructor could not produce a structurally valid Role Capability Blueprint v5 "
