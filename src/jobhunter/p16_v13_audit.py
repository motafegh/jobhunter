"""Mechanical audit helper for isolated English P1.6 v13 snapshots."""
...
from jobhunter.analysis_service_v13 import ENGLISH_PROMPT_VERSION, qualification_list_spans
...
def audit_snapshot(path: Path, *, job_id: str) -> dict[str, int]:
    ...
    _require(
        ...
        "English projection does not match P1.6 v13 candidate",
    )
    ...
    _require(
        ...
        "P1.6 v13 candidate references a different English projection",
    )
    ...
    return {
        ...
        "decomposed": len(coarse_decomposed),
