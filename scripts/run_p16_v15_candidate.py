...
from jobhunter.analysis_runtime_v15 import build_v15_candidate_analysis_service
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run isolated English P1.6 v15 candidate analysis for one current job."
    )
    ...
    try:
        ...
        print(f"P1.6 v15 candidate failed: {exc}", file=sys.stderr)
        return 1
    print(f"Outcome: {result.outcome}")
    print(f"English P1.6 v15 candidate for {result.source_job_id}")
