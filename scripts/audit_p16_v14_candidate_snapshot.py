...
from jobhunter.p16_v14_audit import AuditError, audit_snapshot
...
def main() -> int:
    ...
    try:
        ...
        print(f"Mechanical P1.6 v14 candidate checks: FAIL: {exc}")
        return 1
    print("Mechanical P1.6 v14 candidate checks: PASS")
