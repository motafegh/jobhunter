...
- [x] removed candidate requirement leakage from Benefits/Location/KPI/Tasks/application sections, preserved shared preferred list/group scope, and recovered explicit Job Description/Tasks duties. The repeated 27-projection audit covers 173 requirement refs, 80 responsibility refs and 39 partitions with no collisions, duplicates or non-source spans; accepted v20/v5 artifacts remain untouched.
