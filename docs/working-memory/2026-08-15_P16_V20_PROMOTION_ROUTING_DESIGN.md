...
**Branch:** `agent/p16-v20-promotion-routing`  
**Base:** accepted/calibrated `agent/p16-v20-source-led-partitioning`
...
1. v20 candidate modules import shared types/helpers from `analysis_service.py`, which is the historical v9 implementation;
...
- PR #8 remains calibration/candidate history;
