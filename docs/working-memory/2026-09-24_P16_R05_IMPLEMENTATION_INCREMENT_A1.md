...
**Review:** [Draft PR #9](https://github.com/motafegh/jobhunter/pull/9)  
**Status:** IMPLEMENTED ON ISOLATED BRANCH; REPOSITORY CI PASS; NOT MERGED, NOT A COMPLETE R05 OR LIVE ACCEPTANCE
...
## Deliberate incompleteness / no promotion yet
